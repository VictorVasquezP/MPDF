	...
	function Output($name = '', $dest = '')
	{
		...
		switch ($dest) {
			...
			case Destination::INLINE:
				...
				/**
				 * METODO PARA MOSTRAR EN EL NAVEGADOR DIRECTAMENTE
				 * SE MODIFICÓ PARA QUE ENVÍE EL CONTENIDO EL FORMATO BASE64
				 * PARA QUE SE MUESTRE EN EL FRAME DE LA VISTA
				 */
				/*
				if (PHP_SAPI !== 'cli') {
				...
				*/
				...
				echo base64_encode($this->buffer);
